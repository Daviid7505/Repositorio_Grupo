...
create table `ComunidadAutónoma` (
...
`CodEntrada` int(3) COMMENT 'Código de la entrada al PN',
`CodPN` int(5) COMMENT 'Còdigo del Parque Natural');
...
`DNI` char(9) COMMENT 'DNI del empleado',
`NSS` varchar(20) COMMENT 'Número de seguridad socal',
...
CREATE TABLE `gestor` (
  `DNI` char(9) COMMENT 'DNI',
  `CodEntrada` int(3) COMMENT 'Codigo de entrada'
);
...
insert into `ComunidadAutónoma` (`CodCA`, `Nombre`, `OrgResponsable`) values 
...
INSERT INTO Especie (`CodEspecie`, `NombreCientífico`, `NombreVulgar`) VALUES
...
INSERT INTO Animal (`CodEspecie`, `Alimentación`, `Periodo de celo`) VALUES
...
INSERT INTO Area (`NombreA`, `Extensión km`, `CodPN`) VALUES
('PN Yosemite',3081,500),
('PN Banff',6641,501),
('PN Yellowstone',8983,502),
('PN Kruger',19485,503),
('PN Serengeti',18346,504);

--
-- Insertamos datos en la tabla `Vehiculo`:
--

INSERT INTO Vehiculo (`Matrícula`, `Tipo`, `DNI`) VALUES
...
('23456789B', '45566700', 'Sandra', 'Pla Verez', 977889955, 623500500, 1800, 504),
('34567890C', '90876901', 'Ana', 'Calas Vera', 988675555, 663267788, 1700, 504), 
...
('12345678A', '70145632', 'Horacio', 'Suárez Gala', 934512123, 622100789, 1550, 503),
...
('45678901D', '77732100', 'Felipe', 'Saldívar Lorenzo', 955433211, 611090987, 1950, 500),
('56789012E', '66430012', 'Romina', 'Graff Estévez', 97654340, 664991038, 1800, 500);
...
('12345678A', 'Conducir visitantes', 'PN Yosemite'),
('23456789B', 'Reparar jaula loros', 'PN Banff'),
('34567890C', 'Limpieza cuadra', 'PN Yellowstone'),
('45678901D', 'Alimentar patos', 'PN Kruger'),
('56789012E', 'Entrenar delfines', 'PN Serengeti');
