...
public class EmpleadoDaoImplMyS8 extends AbstractDaoMy8 implements EmpleadoDao{
	
	/*Sobreescribimos el método altaEmpleado. A través de este método, se inserta un 
	*empleado utilizando Eclipse y se refleja en la BBDD. Como el método arroja una
	*excepción, dentro de try definimos las sentencias SQL que pueden causar la excepción
	*En catch, definimos la respuesta que daremos a dicha excepción.
	*/
	@Override
	...
	/*Sobreescribimos el método elimnarUno. Para eliminar un empleado de la tabla, el
	*procedimiento se realizará utilizando el id del empleado. Definimos la sentencia sql y 
	...
	*/
	...
	/*Sobreescribimos el método modificarUno. En este método, a partir del cif de un
	*empleado, se modifican sus datos con la sentencia sql correspondiente. El método 
	*retornará true si la modificación fue exitosa.
	*/
	@Override
	...
	/*Sobreescribimos el método buscarUno. En este método, obtenemos los datos de un 
	 * empleado introducinedo su cif. Si dicho empleado existe, el método retornará
	...
	/*Sobreescribimos el método buscarTodos. Este método devolverá una lista con todos los 
