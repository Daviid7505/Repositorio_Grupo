...
//Generamos el constructor con todos los parametros
	...
	// Generamos equals y hashcode, en los cuales definimos que dos empleados son
	// iguales si
...
//----------------------------------------------------------------------------------------------------------
	...
	public double salarioMensual(int meses) {
		...
		salarioMensual = Math.round(salarioMensual * 100.0) / 100.0;
	...
	public String obtenerEmail() {
		String obtenerEmail = nombre.charAt(0) + apellidos + "@nombreEmpresa.com";
		obtenerEmail = obtenerEmail.toLowerCase();
		return obtenerEmail;
	}
